test_that("use", {
  ...
  tma_filename <- "/home/richel/GitHubs/bianchi_et_al_2017/tmh-predictions/trans-membrane-analysis-shortened.txt" # nolint indeed a long name
  ...
  expect_silent(
    prepare_data(
      ...
      trans_membrane_analysis_filename = tma_filename,
